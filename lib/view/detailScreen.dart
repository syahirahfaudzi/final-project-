...
class _DetailsScreenState extends State<DetailsScreen> {
            ...
            Card(
              ...
              child: Container(
                  ...
                  child: CachedNetworkImage(
                    ...
                    fit: BoxFit.cover,
                    imageUrl:
                        "${Config.server}homestay_raya/assets/productimages/${widget.product.productId}.png",
                ...
                child: Column(children: [
                  ...
                  TextFormField(
                      ...
                      validator: (val) => val!.isEmpty || (val.length < 2)
                          ? "Service name must be longer than 2"
                          : null,
  ...
  void _updateProduct() {
    ...
    http.post(Uri.parse("${Config.server}homestay_raya/php/update_product.php"),
        body: {
